...
const gifElement = document.getElementById("loveHappy-gif");
...
const gifs = ["./assets/images/loveAnime.mp4", "./assets/images/crying1.gif", "./assets/images/kilingAnime.gif", "./assets/images/sadAnime.gif"];
// array of messages
const buttonMessages = ["Are you sure??", "Pookie please", "Abbe yes kar na", "ahhhh......just YES it"];
